...
const FEATURES = [
  {
    ...
    body: "A live tape of Solana CAs from approved off-desk X monitors — one row per call, newest first, with source and trust at a glance.",
  },
  {
    step: "02",
    title: "Track",
    accent: "border-zinc-700/80 bg-zinc-950/50 text-zinc-100",
    body: "Live and ATH multiples per mint, chart links, and echo rows when a second monitor posts the same contract.",
  },
  {
    step: "03",
    title: "Proof",
    accent: "border-emerald-500/30 bg-emerald-950/15 text-emerald-100",
    body: "Pro members propose new handles; staff dual-approve; ingestion runs server-side with trust scores that learn from outcomes.",
  },
] as const;
    ...
    <div className="relative mx-auto max-w-3xl px-4 pb-24 pt-10 sm:px-6">
      ...
      <div className="relative">
        ...
        <p className="mx-auto mt-4 max-w-xl text-center text-sm leading-relaxed text-zinc-400">
          We&apos;re finishing the polish on your off-desk signal lane — the same workflow you&apos;ll use day one:{" "}
          <span className="text-zinc-300">signal → track → proof</span>. Your Pro membership already includes access;
          the tape opens as soon as we flip the switch.
        </p>
        ...
        <div className="mt-10 rounded-2xl border border-zinc-800/80 bg-zinc-950/60 p-5 text-center">
          <p className="text-xs font-semibold uppercase tracking-[0.14em] text-zinc-500">While you wait</p>
          <p className="mt-2 text-sm text-zinc-400">
            The main desk, leaderboard, alerts inbox, and Trusted Pro lane stay fully available on your plan.
          </p>
