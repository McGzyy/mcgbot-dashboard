  ...
  return (
    <div className="space-y-6">
      <AdminPageHeader
        ...
        description="Partner program runs on a separate portal (no terminal sidebar). Same backend data; different URL and login."
      />
      <AdminPanel className="p-5 sm:p-6">
        <p className="text-sm text-zinc-400">
          Partners apply at{" "}
          <span className="font-mono text-zinc-300">{partnerRegister}</span> with email + password and mandatory 2FA.
