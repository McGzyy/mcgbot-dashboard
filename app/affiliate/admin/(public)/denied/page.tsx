  ...
  return (
    <div className="mx-auto flex min-h-[calc(100dvh-0px)] max-w-md flex-col justify-center px-4 py-16">
      ...
      <p className="mt-3 text-sm leading-relaxed text-zinc-600">
        The affiliate ops panel is only for McGBot dashboard administrators. If you want to become an affiliate, apply
        separately — affiliates use email and password on the affiliate portal, not the member dashboard.
      </p>
      <Link
